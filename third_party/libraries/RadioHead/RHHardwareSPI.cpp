...
// EARENDIL MODIFICATION: Added RH_ARDUINO_ARCH_RP2040 flag to the if statement so RadioHead will use BitOrder.
#if ((RH_PLATFORM == RH_PLATFORM_ARDUINO) && defined (__arm__) && (defined(ARDUINO_SAM_DUE) || defined(ARDUINO_ARCH_SAMD) || defined(RH_ARDUINO_ARCH_RP2040))) || defined(ARDUINO_ARCH_NRF52) || defined(ARDUINO_ARCH_STM32) || defined(ARDUINO_ARCH_STM32) || defined(NRF52)
